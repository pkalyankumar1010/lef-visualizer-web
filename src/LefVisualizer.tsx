...
export default function LEFVisualizer({ lefData: propLefData }: { lefData: ViaStack[] }) {
  ...
  // Use lefData from props
  const lefData = propLefData
        ...
        <div className="d-flex justify-content-center align-items-center h-100">
          <div className="text-center">
            ...
            <p className="text-muted small">
              Send data via Monaco Editor on the left.<br />
              {`{ type: 'lef-data', data: [...] }`}
            </p>
          </div>
        </div>
